...
## Typecheck.java
Entrypoint and driver, the basic layout was provided in the assignment.

## MyType.java
This should store a basic collection of types.

## PPrinter.java
The PrettyPrinter class is used for debugging and visualization. It uses the visitor pattern to create a human readable output of the Abstract Syntax Tree.

## SymTableVis.java
SymbolTableVisitor class, this will construct a symbol table by visiting the AST.

## TypeCheckSimp.java
The TypeCheckSimplified class is a bottom-up visitor that does type checking using the Symbol Table generated by the `SymTableVis` class.